...
public class ReadFromfile3 {
	...
	String	filename;
	Scanner input;
	public ReadFromfile3() throws FileNotFoundException,IOException {
	...
	public void readFileAndAnalyse(String fn)throws FileNotFoundException,IOException {
		...
		this.filename = fn; File f=new File(filename); input=new Scanner(f);
		int k; k=maxLength(fn);
		int n1=NoOfWords(fn);
		System.out.println("======================================");
	...
	public int getNoOfLines()throws FileNotFoundException,IOException {
